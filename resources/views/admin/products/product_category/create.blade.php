                                ...
                                <div class="select">
                                    <select class="" name="parent_id">
                                        ...
                                        @foreach ($productCategories as $val) <!-- Đổi từ $postCategories sang $productCategories -->
                                            ...
                                            isset($productCategory->parent_id) ? $productCategory->parent_id : '')) selected
                                            @endif
                                            value="{{ $val->id }}">
                                                @php
                                                    $str = '';
                            ...
                            <div class="upload-image flex-grow">
                                ...
                                <div id="upload-file" class="item up-load">
                                    <label class="uploadfile" for="myFile">
                                        ...
                                        <input type="hidden" id="oldImage" name="oldImage" value="{{ old('oldImage', $productCategory->image ?? '') }}">
                                    </label>
                                </div>
                            </div>
                        </fieldset>
