<form action="{{ route('user.index') }}">
    ...
    <div class="fill-deleted">
        <a class="all" href="{{ route('user.index') }}"> Tất cả</a> |
        <a class="trash" href="#">Thùng rác <span>({{ count($countDeleted)}})</span></a>
    </div>
    <div class="flex items-center justify-between gap10 flex-wrap">
        <div class="wg-filter wg-filter-user">
        ...
        <a class="tf-button style-1 w208" href="{{ route('user.create') }}"><i class="icon-plus"></i>Thêm mới</a>
    </div>
</form>
