...
<div class="container">
    ...
    <div class="wg-box">
            ...
            <div class="upload-image flex-grow">
                ...
                <div id="upload-file" class="item up-load">
                    <label class="uploadfile" for="myFile">
                        ...
                        <input type="file" id="myFile" name="image" accept="image/*"> <!-- Bỏ 'required' nếu không cần -->
                    </label>
                </div>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="cols">
                <input type="number" name="order" min="0" value="{{ old('order', $banner->order) }}" required placeholder="Enter order"> <!-- Điền giá trị cũ -->
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="cols">
                <input type="number" name="position" min="0" value="{{ old('position', $banner->position) }}" required placeholder="Enter position"> <!-- Điền giá trị cũ -->
            </div>
        </fieldset>
