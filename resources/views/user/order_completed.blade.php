        ...
        <section class="shop-checkout container">
            ...
            <div class="order-complete">
                <div class="order-complete__message">
                    ...
                    <p style="color: red;">Vui lòng để ý điện thoại chúng tôi sẽ liên lạc sau !!!</p>
                </div>
                <div class="order-info">
                    ...
                    <div class="order-info__item">
                        ...
                        <span>{{ number_format($order->total - $discountAmount, 0, '.', ',') . ' VNĐ' }}</span>
                    </div>
                    <div class="order-info__item">
                    ...
                    <div class="checkout__totals">
                        ...
                        <table class="checkout-totals">
                            <tbody>
                                <tr>
                                    <th>TỔNG PHỤ</th>
                                    <td style="text-align: end">{{ number_format($order->total, 0, '.', ',') . ' VNĐ' }}</td>
                                </tr>
                                <tr>
                                    <th>GIÁ GIẢM</th>
                                ...
                                <tr>
                                    <th>GHI CHÚ</th>
                                    <td style="text-align: end">{{ $order->customer_note  }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
